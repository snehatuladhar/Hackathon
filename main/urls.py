...
urlpatterns = [
    ...
    path('instructorProfile/<str:id>/', views.profile, name='profile_instructor'),
    ...
    path('course-material/detail/<int:code>/<int:id>/',
         views.courseMaterial, name='viewCourseMaterial'),
    path('course-material/edit/<int:code>/<int:id>/',
    ...
    path('changePasswordInstructor/', views.changePasswordInstructor,
         name='changePasswordInstructor'),
    path('changePhoto/', views.changePhoto, name='changePhoto'),
    path('changePhotoInstructor/', views.changePhotoInstructor,
         name='changePhotoInstructor'),
